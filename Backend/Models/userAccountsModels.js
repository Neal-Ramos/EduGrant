...
exports.getUserByEmail = (userEmail) => {
    return query("SELECT * FROM useraccount WHERE userEmail = ?", [userEmail])
}
exports.inserNewUser = (firstName, middleName, lastName, userEmail, encryptPassword) => {
    return query("INSERT INTO useraccount(firstName, middleName, lastName, userEmail, userPassword) VALUES(?, ?, ?, ?, ?)",
