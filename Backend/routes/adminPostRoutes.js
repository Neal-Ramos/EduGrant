...
router.post("/adminAddScholarships", upload.fields([{ name: 'sponsorLogo', maxCount: 1 },{ name: 'coverImg', maxCount: 1 }, { name: 'applicationForm', maxCount: 1 }]) ,adminPostControllers.adminAddScholarships)
