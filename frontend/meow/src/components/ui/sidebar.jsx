...
function SidebarHeader({ className, ...props }) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 bg-green-800", className)}
      {...props}
    />
  );
}
